...
export default function Stats() {
  ...
  const warningLabel = caffeineLevel < statusLevels['low'].maxLevel ? 'low' : 
    ...
    <>
      ...
      <StatCard lg  title="Active Caffeine Level">
        <div className="status">
          ...
          <h5 style={{color: statusLevels[warningLabel].color, background : statusLevels[warningLabel].background}}>{warningLabel}</h5>
        </div>
        <p>{statusLevels[warningLabel].description}</p>
      </StatCard>
